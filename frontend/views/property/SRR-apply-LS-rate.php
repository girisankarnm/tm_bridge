    ...
    <div class="hotels-client-table-wrapper">
        ...
        <div class="contets-area-wrapper">
            <div class="room-rates-area-wrapper">
                ...
                <div class="table-responsive">
                    <table class="common-table hotels-client-table">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="2" class="table-td">SLAB RATE TOTAL</td>
                                <td colspan="2" class="table-td">Lumpsum Rate</td>
                                <td colspan="2" class="table-td">VARIANCE</td>
                            </tr>
                            <tr>
                                <td colspan="2"><span class="bold-red-value">₹6,400</span></td>
                                <td colspan="2"><input class="td-input" placeholder="Enter Amount"></td>
                                <td colspan="2"><span class="bold-red-value">₹6,400</span></td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="room-rates-area-wrapper">
                <div class="contets-area-header">
                    <div class="left">
                        <h5 class="contets-area-heading">Deluxe room with private room</h5>
                        <div class="meals-area ml-2">
                            <figure>
                                <img src="images/search-popup/food-icon.svg" alt="">
                                <span class="info-icon">
            ...
            <div class="show-activity-wrapper">
                <div class="activity-chat-wrapper">
                    ...
                    <div class="activity-chat-single">
                        ...
                        <div class="activity-chat-area">
                            <textarea name="" id="" cols="30" rows="10"
                                class="activity-chat">Lorren ippsum gravida sem? Lorren ippsum gravida sem?</textarea>
                        </div>
                    </div>
                    <div class="activity-chat-single">
                        <div class="activity-chat-user">
