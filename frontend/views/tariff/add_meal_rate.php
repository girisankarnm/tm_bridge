            ...
            <div class="row">
                <table id="meals"  class="table3mealsadd" >
                    ...
                    <tr>
                        ...
                        <td class="Adults"> <input id="breakfast_rate_adult" name="breakfast_rate_adult" type="number" class="mealfonttext" value="<?= ($meals_type) ? $meals_type->rate_adult : "" ?>" required  > </td>
                        <td class="Adults"> <input id="breakfast_rate_child" name="breakfast_rate_child" type="number" class="mealfonttext" value="<?= ($meals_type) ? $meals_type->rate_child : "" ?>"  required > </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="Adults">  <input id="lunch_rate_adult" name="lunch_rate_adult" type="number" class="mealfonttext" value="<?= ($meals_type) ? $meals_type->rate_adult : "" ?>" required /></td>
                        <td class="Adults">  <input id="lunch_rate_child" name="lunch_rate_child"  type="number" class="mealfonttext"  value="<?= ($meals_type) ? $meals_type->rate_child : "" ?>" required /> </td>
                    </tr>
                    <tr>
                        ...
                        <td class="Adults">  <input id="dinner_rate_adult" name="dinner_rate_adult"  type="number" class="mealfonttext" value="<?= ($meals_type) ? $meals_type->rate_adult : "" ?>" required /></td>
                        <td class="Adults">  <input id="dinner_rate_child" name="dinner_rate_child"  type="number" class="mealfonttext" value="<?= ($meals_type) ? $meals_type->rate_child : "" ?>" required /></td>
                    </tr>
                </table>
            </div>
            <div class="row" style="margin-left: 4px;margin-bottom: 12px;">
                <div style="display: block;margin-right: 35px;margin-top: 10px">
