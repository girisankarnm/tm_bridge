<div class="$content">
    ...
    <div class="container-fluid" >
        ...
        <div class="tariffBorder">
            ...
            <div class="tab" >
                  <a href="<?= \yii\helpers\Url::to(['/tariff/tariffmotherdaterange']) ?>">  <button class="selectedButtonmotherdaterange"  >Mother date range</button></a>
            ...
            <div style="display: inline">  <a href="<?= \yii\helpers\Url::to(['/enquiry/accommodation']) ?>"><button class="selectedButtonmotherdaterange">Mandatory dinner</button></a> <hr class="new6" > </div>
            </div>
            <hr class="sidebar-divider hrdivider">

            <div class="tariffBorder3" style="display: block">
                <div class="daterangetitle">
                    Mother date range defined for
    ...
    <i style="font-size: 13px;color: gold;padding-left: 2px" class="fa fa-star" aria-hidden="true"></i>
                        <BUTTON type="button" style="float: right" class="motherdateRangeButton"  data-toggle="modal" data-target="#logoutModal">  <i class="fa fa-plus-circle plusbuttonspace" aria-hidden="true"></i>Add new mother date range </BUTTON>
    <br>
