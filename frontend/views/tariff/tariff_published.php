...
<div class="row" style="  margin-left: 3px;margin-top: 5px">
    <div id="maintick"  >
        ...
        <div class="row" style=" margin-bottom: 10px; margin-left: 3px;margin-top: 5px">
            <p style="font-size: 11px;font-weight: 500"> Your Tariff for the period is success fully validated <br>You shall review the tariff (<a href="#"  ><span style="color: #E40968"> url to tariff report </a>) before you publish the name</p>
        </div>
        <div class="row" style="  margin-left: 3px">
