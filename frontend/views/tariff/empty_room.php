...
<body>
<div style="text-align: center; border: 0px solid black; padding: 10px; color: #586ADA;margin-top: 12px; margin-right: 74px;">Your property doesn't have any room categories. </div>
<main class="container py-5">
        ...
        <div class="col-sm-1 col-lg-1 mb-1 " style="overflow: hidden">
           ...
           <div class="col-sm-6 col-lg-2 mb-3">
            <div class="card card-resize" >
                ...
                <h6 class="h8class smallFonts padding-4px ">Define room, Check in/out. Smoking, Pets...</h6>
    ...
    <div style="text-align: center; border: 0px solid black; padding: 10px; color: #586ADA;margin-top: 12px"><button class="property-button" onclick="location.href='<?= Url::toRoute(['/property/createcategories', 'id' => $property->id]) ?>'">Define room categories</button></div>
