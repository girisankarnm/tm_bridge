                ...
                foreach ($mother_ranges as $range) {
                    ...
                    <div class="card matherdaterangecard" >
                        ...
                        <div style="display: flex">
                            <div id="main2"  >
                                <div></div>
                                <div ><h6  class="motherdaterange-H6  smallFonts" style="padding-top: 0px; font-size: 10px; line-height: 0;"><img s src="images/user-icon.svg" style="color: #545b62;margin-right: 4px" aria-hidden="true"></img>Arjun Raj</h6></div>
