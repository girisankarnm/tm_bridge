...
<br>
  <div style="display: inline">  <small  class="smallclass"><i style="font-size: 10px;color: red;top: 0px" class="fa fa-map-marker" aria-hidden="true"></i>wyanad,kerala,india</small>
    ...
    <!--    <div class="commonTitleMother" style="display: inline">-->
    <div class="row" >
        ...
        <!--        <div style="text-align: right">   Added Mother Dates </div>-->
    </div>

    <!--    <div class="flex-container" style="justify-content: right;margin-right: 20px;">-->
    <!--        <div class="commonTitleMother2">Added Mother Dates</div>-->
    <!---->
    <!---->
