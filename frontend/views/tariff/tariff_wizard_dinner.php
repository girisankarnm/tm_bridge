<div class="$content">
    ...
    <i style="font-size: 13px;color: gold;padding-left: 2px" class="fa fa-star" aria-hidden="true"></i>
<br>
  <div style="display: inline">  <small  class="smallclass"><i style="font-size: 10px;color: red;top: 0px" class="fa fa-map-marker" aria-hidden="true"></i>wyanad,kerala,india</small>
</span></div>
        </div>
    </div>
    ...
    line-height: 0;"> may 25 2022 </h6></div>
        ...
        <div class="row">
            <table id="customers" class="table2class" style="width: 655px;">
                ...
                <tr>
                    <td>  <input type="date" class="inputTextClass" style="width: 100px;height: 33px;margin-top: 24px;" ></td>
                    <td>  <input type="number" class="inputTextClass" style="width: 100px;height: 33px;margin-top: 24px;" ></td>
                    <td >  <input type="number" class="inputTextClass" style="width: 100px;height: 33px;margin-top: 24px;" >

                    </td>
                    <td>  <input type="text" class="inputTextClass" style="width: 100px;height: 33px;margin-top: 24px;" ></td>
                </tr>
                <tr >
                    <td>  <input type="date" class="inputTextClass" style="width: 100px;height: 33px" ></td>
                    <td>  <input type="number" class="inputTextClass" style="width: 100px;height: 33px" ></td>
                    <td >  <input type="number" class="inputTextClass" style="width: 100px;height: 33px" >
                    </td>
        ...
        <div class="row" style="margin-left: 4px;margin-bottom: 12px;">
            <div style="display: block;margin-right: 35px">
                ...
                <BUTTON type="button" class="buttonSave" style="width: 80px;height: 30px" data-toggle="modal" data-target="#logoutModal"> Save </BUTTON>
            </div>
    ...
    <!--                <div class="row" style="margin-left: 3px;margin-bottom: 12px;">-->
    <!--                    <div style="display: block;margin-right: 35px">-->
    <!--                        <BUTTON type="text" class="buttonSave"  style="width:130px "> Save </BUTTON>-->
    <!--                    </div>-->
