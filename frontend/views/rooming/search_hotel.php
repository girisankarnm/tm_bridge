        ...
        <div class="col-md-9 search-main">
            ...
            <div class="search-results mb-2">
                <div class="card property-card-list shadow-div" >
                    ...
                    <div id="mainHeding-search-listing"style="height: 43px">
                        <div > <img class="image-property img-property" src="images/chess-board.jpg" alt="Matrix"></div>
                        <div>
                            <div id="column-2-serching-listing">
                                <div>

                          <span class="hotelHeading" > <span class="cut-text" style="display: inline">Hotel Abc<span/> <img class="f-star" src="images/Star-1.svg" alt="Matrix">
                           ...
                           <img  class="f-star" style="padding-left: 2px" src="images/Star-1.svg" alt="Matrix">
                                ...
                                <div >
                                    <div id="hotel-properties">
                                        <div class="mr-2">  <img src="<?= Yii::$app->request->baseUrl . 'images/smoking.png' ?>" alt="smoking.png" class="img-fluid-search"></div>
                                        <div class="mr-2">  <img src="<?= Yii::$app->request->baseUrl . 'images/smoking.png' ?>" alt="smoking.png" class="img-fluid-search"></div>
                                    </div>
                        ...
                        <div >
                            <div id="price-flex">
                                <div >
                                    <p class="mb-0" style="color: orange; text-decoration: line-through;"> ₹ 10,900 </p>
                                </div>
                                <div >
                                    <p class="mb-0" style="color: orange"> ₹ 10,246 </p>
                                </div>
